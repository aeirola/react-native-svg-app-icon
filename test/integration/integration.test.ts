...
describe("integration tests", () => {
  ...
  it("generates files from complex matching fixtures", () => testFixture("complex", 0.1));
  ...
  it("generates with appropriate scaling pattern", () => testFixture("scaling-pattern"));

  async function testFixture(fixture: string, imageThreshold = 0): Promise<void> {
